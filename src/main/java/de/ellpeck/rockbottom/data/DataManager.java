...
public class DataManager implements IDataManager {
    ...
    static {
        ...
        Registries.PACKET_REGISTRY.register(27, PacketSound.class);
        Registries.PACKET_REGISTRY.register(28, PacketActiveItem.class);
        Registries.PACKET_REGISTRY.register(29, PacketChestOpen.class);
        Registries.PACKET_REGISTRY.register(30, PacketSignText.class);
        Registries.PACKET_REGISTRY.register(31, PacketReject.class);
        Registries.PACKET_REGISTRY.register(32, PacketTime.class);
        Registries.PACKET_REGISTRY.register(33, PacketAttack.class);
        Registries.PACKET_REGISTRY.register(34, PacketEffect.class);
        Registries.PACKET_REGISTRY.register(35, PacketSetOrPickHolding.class);
        Registries.PACKET_REGISTRY.register(36, PacketStats.class);
        Registries.PACKET_REGISTRY.register(37, PacketAITask.class);
        Registries.PACKET_REGISTRY.register(38, PacketToolBreak.class);
        Registries.PACKET_REGISTRY.register(39, PacketDamage.class);
        Registries.PACKET_REGISTRY.register(40, PacketSkill.class);
        Registries.PACKET_REGISTRY.register(41, PacketPlayer.class);
        Registries.PACKET_REGISTRY.register(42, PacketChangeWorld.class);
        Registries.PACKET_REGISTRY.register(43, PacketCutscene.class);
